    ...
    >
      ...
      >
        <motion.div
          ...
          className="inline-flex items-center gap-2 px-4 py-1.5 rounded-full text-[11px] font-bold bg-emerald-500/10 text-emerald-400 border border-emerald-500/20 shadow-inner"
        >
        ...
        <motion.div
          ...
          className="absolute -bottom-2 sm:bottom-4 left-1/2 -translate-x-1/2 flex flex-col items-center gap-2 text-gray-500"
        >
